...
from ViCLIP.viclip_vision import clip_joint_l14
from ViCLIP.viclip_text import clip_text_l14
...
class ViCLIP(nn.Module):
    ...
    def tokenize(self, text: list):
        """tokenize text using the tokenizer of the text encoder."""
        device = next(self.text_encoder.parameters()).device
        text_embeds = self.text_encoder.tokenize(
